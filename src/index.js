    ...
    return (
      <>
        ...
        <div className="form-group">
          ...
          <input className="form-control" value={this.state.inputKey} onChange={this.handleInputKeyChange} style={{width:'20%', height:30}} placeholder="Key" />  current key: ec3f32b25d16f1eca23709b7b06490aa
        </div>
        ...
        <h2>Crypto-JS (decryptAES)</h2>
          ...
          <input className="form-control" value={this.state.key} onChange={this.handleDecryptKeyChange} style={{width:'20%', height:30}} placeholder="Key" />  current key: ec3f32b25d16f1eca23709b7b06490aa
        </div>
